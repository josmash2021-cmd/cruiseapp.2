...
def sync_driver(user_id: int, first_name: str, last_name: str,
                ...
                created_at: datetime = None, has_password: bool = False,
                is_verified: bool = False, id_document_type: str = None,
                id_photo_url: str = None, selfie_url: str = None,
    ...
    async with session_maker() as db:
        ...
        for u in riders:
            sync_client(
                ...
                has_password=u.password_hash is not None and len(u.password_hash or "") > 0,
        ...
        for d in drivers:
            sync_driver(
                ...
                has_password=d.password_hash is not None and len(d.password_hash or "") > 0,
