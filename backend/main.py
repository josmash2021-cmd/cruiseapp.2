...
async def lifespan(app: FastAPI):
    ...
    async def _bg_init():
        ...
        # NOTE: Reduced agents due to PgBouncer connection limits.
        # Re-enable full agents when moving to direct DB connection.
        await asyncio.sleep(5)
        wait_timeout_agent.set_db_session_maker(SessionLocal)
        await wait_timeout_agent.start()

        # Phase 3: Low-priority agents (DISABLED to save connections)
        ...
        # Phase 4: Periodic tasks (30s delay) — reduced frequency
