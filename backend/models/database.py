...
class User(Base):
    ...
    inspection_url = Column(Text, nullable=True)
...
async def migrate_postgres(conn):
    ...
    migrations = [
        ...
        ("trips", "meet_inside", "BOOLEAN DEFAULT FALSE"),
        ("trips", "scheduled_surcharge", "FLOAT DEFAULT 0.0"),
        ("trips", "airport_fee_applied", "FLOAT DEFAULT 0.0"),
        ("trips", "meet_greet_fee", "FLOAT DEFAULT 0.0"),
