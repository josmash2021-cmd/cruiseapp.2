...
<div style="font-size:10px;font-weight:800;letter-spacing:.14em;color:#8a7e4e !important;text-transform:uppercase;">{lbl_pickup}</div>
<div style="font-size:14px;font-weight:600;color:#E8C547 !important;margin-top:2px;word-break:break-word;">{pickup}</div>
</td>
</tr>
<tr><td colspan="2" style="padding:4px 0 4px 4px;"><div style="width:2px;height:18px;background:linear-gradient(180deg,#E8C547,rgba(232,197,71,.3));margin-left:4px;"></div></td></tr>
<tr>
<td width="22" valign="top" style="padding-top:4px;">
<div style="width:10px;height:10px;background:#fff;border-radius:2px;"></div>
</td>
<td style="padding-left:8px;padding-bottom:6px;">
<div style="font-size:10px;font-weight:800;letter-spacing:.14em;color:#8a7e4e !important;text-transform:uppercase;">{lbl_dropoff}</div>
<div style="font-size:14px;font-weight:600;color:#ffffff !important;margin-top:2px;word-break:break-word;">{dropoff}</div>
</td>
</tr>
</table>
</td></tr></table>
