...
class S {
  ...
  String get termsAcceptanceBody => _es
      ? 'Al descargar, acceder o usar la aplicación Cruise ("App"), usted acepta estar sujeto a estos Términos y Condiciones ("Términos"). Si no está de acuerdo con estos Términos, por favor no use la App. Estos Términos constituyen un acuerdo legalmente vinculante entre usted y Cruise in Ride LLC ("Cruise", "nosotros" o "nuestro").'
      : 'By downloading, accessing, or using the Cruise application ("App"), you agree to be bound by these Terms and Conditions ("Terms"). If you do not agree to these Terms, please do not use the App. These Terms constitute a legally binding agreement between you and Cruise in Ride LLC ("Cruise," "we," or "our").';
  ...
  String get termsIpBody => _es
      ? 'El nombre, logotipo, diseño de la app y todo el contenido relacionado de Cruise son propiedad de Cruise in Ride LLC y están protegidos por leyes de propiedad intelectual. No puede copiar, modificar, distribuir ni crear trabajos derivados sin nuestro consentimiento previo por escrito.'
      : 'The Cruise name, logo, app design, and all related content are the property of Cruise in Ride LLC and are protected by intellectual property laws. You may not copy, modify, distribute, or create derivative works without our prior written consent.';
  ...
  String get termsContactBody => _es
      ? 'Si tiene alguna pregunta sobre estos Términos, contáctenos:\n\nCruise in Ride LLC\nEmail: support@cruiseinride.com\nSoporte: support@cruiseinride.com'
  ...
  String get navCruiseNav => _es ? 'Navegación Cruise' : 'Cruise Navigation';
